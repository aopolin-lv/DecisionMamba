...
from transformers import GPT2Config, MambaConfig

class GPT2Config_LoRA(GPT2Config):
    def __init__(
        self,
        lora_attn_dim=16,
        lora_attn_alpha=32,
...
class MambaConfig_LoRA(MambaConfig):
    def __init__(
        self,
        lora_attn_dim=16,
        lora_attn_alpha=32,
...
class GPT2PreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, (nn.Linear, Conv1D)):
            ...
            print("random initializing embedding")
            module.weight.data.normal_(mean=0.0, std=self.config.initializer_range)
            if module.padding_idx is not None:
                module.weight.data[module.padding_idx].zero_()
        elif isinstance(module, nn.LayerNorm):
            print("initializing layer norm to be identity")
            module.bias.data.zero_()
        ...
        for name, p in module.named_parameters():
            if "c_proj" in name and "weight" in name:
                print("initializing {} with scaling".format(name))
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, GPT2Model_LoRA):
...
class GPT2Model_LoRA(GPT2PreTrainedModel):
...
class GPT2LMHeadModel_LoRA(GPT2PreTrainedModel):
